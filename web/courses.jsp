...
<div class="wrapper col2">
    <div id="topnav">
        <ul>
            ...
            <li class="active"><a href="<s:url action='queryCourse' />">Courses</a>
            </li>
        </ul>
    </div>
</div>
...
<div class="wrapper col4">
    <div id="courses">
        <!--<p>Courses : <input type="text" name="fname">  Passing Score : <input type="text" name="fname">  <button type="button"> add</button><button type="button"> edit</button></p>-->
        <table style="padding: 0px 0px 0px 500px;">
            <s:form name="queryCourseForm" action="queryCourse" theme="simple" method="post">
                <tr>
                ...
                <s:iterator value="course">
                    <tr style="color: black">
                        <td style="display: none"><s:textfield name="courseid" value="%{courseid}"/></td>
